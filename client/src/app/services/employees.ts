...
export const employeesApi = api.injectEndpoints({
	endpoints: (builder) => ({
		...
		getAllEmployee: builder.query<Employee, string>({
			query: (id) => ({
				url: `/employees/${ id }`,
				method: 'GET',
			}),
...
export const { endpoints: { getAllEmployees, getAllEmployee, editEmployee, removeEmployee, addEmployee } } = employeesApi;